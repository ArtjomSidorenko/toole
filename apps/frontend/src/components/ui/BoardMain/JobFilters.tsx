...
export default function JobFilters() {
  return (
    <aside className="md:sticky md:top-20 md:self-start">
      <Accordion defaultValue="filters" type="single" collapsible className="w-full md:w-[350px]">
        <AccordionItem value="filters">
          <AccordionTrigger className="w-[350px] text-md shadow-lg border-t cursor-pointer decoration-0 no-underline hover:no-underline">
            Filters
          </AccordionTrigger>
          <AccordionContent>
            <div className="w-full md:w-[350px] mt-3">
